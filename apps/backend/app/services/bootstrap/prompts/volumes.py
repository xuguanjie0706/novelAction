...
def build_volumes_prompt(project: Project, ctx: dict) -> tuple[str, str]:
    ...
    hook_block = collect_step_hooks("volumes", ctx)
...
设定摘要：{ctx.get('settings_summary', '')}{storyline_hint}{villain_block}{positioning_block}{hook_block}{entity_block}{roster_block}{kit_block}{protag_block}
