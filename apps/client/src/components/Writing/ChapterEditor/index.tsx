      ...
      <div className="flex flex-1 min-h-0">
        ...
        <ContextSidePanel
          ...
          debriefPanelProps={{
            ...
            aiNextChapterDirectives: debrief.aiNextChapterDirectives,
            aiSpeechKitUpdates: debrief.aiSpeechKitUpdates,
            ...
            onRemoveNextChapterDirective: idx => debrief.setAiNextChapterDirectives(prev => prev.filter((_, i) => i !== idx)),
            onRemoveSpeechKitUpdate: idx => debrief.setAiSpeechKitUpdates(prev => prev.filter((_, i) => i !== idx)),
