...
export default function CharacterRoster({ characters, assets, relations, selected, onSelect }: Props) {
  // 预聚合：每人持有资产数 / 对主角态度。
            ...
            <div key={g.key} className="mb-3">
              ...
              <ul className="space-y-0.5">
                {g.members.map((c, i) => {
                  ...
                  const realm = field(c, 'start_realm')
